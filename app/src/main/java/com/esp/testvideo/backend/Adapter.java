...
import com.esp.testvideo.TestApplication;
...
public class Adapter {
    ...
    public void doPost(final String tag, String url,
                       HashMap<String, String> mParams,
                       final APIResponseListener responseListener,
                       final Response.ErrorListener errorListener, final boolean showAlert) {
        ApiRequest apiReq = null;
        try {

            apiReq = new ApiRequest(Request.Method.POST, url, mParams,
...
//													true).show();
            ...
            TestApplication.getInstance().addToRequestQueue(apiReq,tag);
        } catch (Exception e) {
    ...
    public void doPut(final String tag, String url,
        ...
        try {
            ...
            apiReq = new ApiRequest(Request.Method.PUT, url, mParams,
                    new Response.Listener<String>() {
...
//												error.getMessage(), "OK", true);
            ...
            // Adding request to request queue
            TestApplication.getInstance().addToRequestQueue(apiReq,
                    tag);
        } catch (Exception e) {
            Log.error("Exception", e);
            System.gc();
    ...
    public void doGet(final String tag, String url,
                      ...
                      final Response.ErrorListener errorListener) {
        try {
            ApiRequest apiReq = new ApiRequest(Request.Method.GET, url, mParams,
                    new Response.Listener<String>() {
    ...
    public void doCancel(String tag) {
        try {
            TestApplication.getInstance().cancelPendingRequests(tag);
        } catch (Exception e) {
            Log.error("Exception", e);
        }
    }
